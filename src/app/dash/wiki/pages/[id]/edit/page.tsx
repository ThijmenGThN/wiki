...
export default function EditPagePage({ params }: { params: Promise<{ id: string }> }) {
	...
	const page = useQuery(api.admin.getPageById, { id: id as Id<"pages"> })
	const categories = useQuery(api.wiki.getCategories)
	const updatePage = useMutation(api.admin.updatePage)
		...
		<div className="container mx-auto py-8 px-4 max-w-7xl">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Update page content and information</CardDescription>
				</CardHeader>
				<CardContent>
